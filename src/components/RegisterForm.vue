...
<template>
  <div class="mx-auto max-w-sm bg-transparent p-6 text-[var(--foreground)]">
    <div class="mb-4">
      <h1 class="text-2xl font-semibold pb-6 uppercase">Create your account</h1>
      <p class="text-sm opacity-80">Choose a username and password to get started</p>
    </div>
    ...
    <div class="mt-4 text-center text-sm">
      ...
      <router-link to="/login" class="ghost-underline">Log in</router-link>
    </div>
  </div>
  </template>
